...
guide.addRows([
  ...
  ["숫자", "수량과 단가는 0 이상의 정수로 적어 주세요. 쉼표는 써도 됩니다."],
...
const inventoryColumns = [
  ...
  { header: "남은 수량", key: "qty", width: 14, required: true, align: "right", numFmt: "#,##0" },
...
wholeNumberValidation(inventory, "F4:G2004");
...
wholeNumberValidation(lots, "F4:G1004");
