    ...
    >
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div className="space-y-2">
          ...
          <dl className="grid gap-1 text-muted-foreground sm:grid-cols-2 sm:gap-x-6">
            <div>
              <dt className="font-medium text-foreground">부분 로드</dt>
              <dd>화면 골격을 유지하며 지점 행 데이터를 기다리는 중입니다.</dd>
            </div>
            <div>
              <dt className="font-medium text-foreground">마지막 갱신 시각</dt>
