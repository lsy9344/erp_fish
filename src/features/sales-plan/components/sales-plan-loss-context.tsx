...
// 손실 입력 화면에서 3단계 재고의 판매한 가격을 손실액 산정 기준으로 보여준다.
// 실제 판매/회수액을 입력하면 저장 시 판매한 가격와의 차액이 손실액이 된다.
        ...
        {items.map((item) => (
          ...
          >
            ...
            <span className="tabular-nums">
              판매한 가격 {formatKrw(item.plannedUnitPrice)}
