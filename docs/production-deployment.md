...
- 최초 배포일: 2026-06-21
- 최초 배포 브랜치: `new_function`
- 현재 프로덕션 브랜치: `main`
- 테스트 배포 브랜치: `staging`
- 프로덕션 URL: https://erp-fish.vercel.app
- 테스트 URL: https://erp-fish-git-staging-noahs-projects-731be159.vercel.app
...
- **브랜치 배포**: Vercel Production Branch는 `main`이다. 테스트용 Preview
  브랜치로 `staging`을 사용하며, 고정 브랜치 URL은
  `https://erp-fish-git-staging-noahs-projects-731be159.vercel.app`이다.
  `staging`에는 Preview 전용 `AUTH_SECRET`, `AUTH_TRUST_HOST`를 등록했다.
